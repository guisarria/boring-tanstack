...
const Layout = ({ children, className, style }: ComponentProps) => (
  <html
    lang="en"
...
const Main = ({ children, className, id, style }: ComponentProps) => (
...
const Section = ({ children, className, id, style }: ComponentProps) => (
  <section
    className={cn("items-center w-full flex flex-col", className)}
    id={id}
    style={style}
  >
    {children}
