...
export default function VerificationEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        {name ? `${name}, verify` : "Verify"} your email to get started with
        Boring TanStack
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={footerSection}>
            <Text style={footer}>
              You received this email because a new account was created with
              this address. If this wasn't you, you can safely ignore this
              email.
            </Text>
